...
def test_delete_action_moves_outputs_to_trash(tmp_path: Path, make_rom) -> None:
    config = make_config(tmp_path)
    # Set up the on-disk state: primary file.
    ...
    # File is in the trash, with the gc/ subdir preserved.
