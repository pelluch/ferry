"""Tests for ferry.adapters.dolphin.gamecube_config.parse_gamecube_memcard_settings."""
...
def test_missing_file_returns_none(tmp_path: Path) -> None:
    assert parse_gamecube_memcard_settings(tmp_path / "Dolphin.ini") is None
...
def test_empty_ini_uses_modern_defaults(tmp_path: Path) -> None:
    ...
    result = parse_gamecube_memcard_settings(ini)
